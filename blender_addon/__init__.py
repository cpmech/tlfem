...
bl_info = {
    ...
    'version'     : (2, 0),
    'blender'     : (4, 0, 0),
    'location'    : 'View3D > Sidebar > FEMmesh mesh generator',
    'warning'     : '',
...
def draw_callback_px(self, context):
    ...
    if len(ob.vtags)>0 and sc.pyfem_show_vtag:
        blf.size(font_id, sc.pyfem_vert_font)
    ...
    if len(ob.etags)>0 and sc.pyfem_show_etag:
        blf.size(font_id, sc.pyfem_edge_font)
    ...
    if len(ob.ctags)>0 and sc.pyfem_show_ctag:
        blf.size(font_id, sc.pyfem_cell_font)
...
class VIEW3D_PT_FEMmeshPanel(bpy.types.Panel):
    bl_label       = "CIVL4250 FEMmesh"
    bl_space_type  = "VIEW_3D"
    bl_region_type = "UI"
    bl_category    = "FEMmesh"
    bl_idname      = "VIEW3D_PT_FEMmeshPanel"
    ...
    def draw(self, context):
        ...
        l.label(text="View in Matplotlib:")
        c = l.column(align=True)
        r = c.row(align=True)
...
def unregister():
    ...
    del bpy.types.Scene.pyfem_default_edge_tag
    del bpy.types.Scene.pyfem_default_vert_tag
    del bpy.types.Scene.pyfem_default_cell_tag
    del bpy.types.Scene.pyfem_show_etag
    del bpy.types.Scene.pyfem_show_vtag
    del bpy.types.Scene.pyfem_show_ctag
    del bpy.types.Scene.pyfem_vert_font
    del bpy.types.Scene.pyfem_edge_font
    del bpy.types.Scene.pyfem_cell_font
    del bpy.types.Scene.pyfem_vert_color
    del bpy.types.Scene.pyfem_edge_color
    del bpy.types.Scene.pyfem_cell_color
    del bpy.types.Scene.pyfem_flatten
    del bpy.types.Scene.pyfem_msys_with_ids
    del bpy.types.Scene.pyfem_msys_with_tags
